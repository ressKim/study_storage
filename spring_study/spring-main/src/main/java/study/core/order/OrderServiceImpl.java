...
public class OrderServiceImpl implements OrderService {
    ...
    /**
     * @Autowired -- 의존성 주입 방법중 얼마전까지 많이 사용되던
     * 필드 주입 방식이다 - 이 방식은 테스트 코드를 짠다고 가정해서 생각하면
     * 관련된 test 코드 전체가 스프링에 의존하는 경우가 발생하게 된다.
     * 어플리케이션과 관계없는 테스트도 말이다. 그래서 이거의 사용은 왠만하면 피하자.
     */
