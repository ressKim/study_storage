package com.study.jdbc.exception.translator;
...
import com.study.jdbc.repository.ex.MyDbException;
import com.study.jdbc.repository.ex.MyDuplicateKeyException;
...
public class ExTranslatorV1Test {
  ...
  void duplicateKeySave() {
    service.create("myId");
    service.create("myId");//중복된 아이디 가입 시도
  }
